...
def-env activate-virtualenv [] {
    ...
    let virtual-env = 'C:\Users\BrainzMedia\Desktop\mission_statement'
    let bin = 'Scripts'
    let path-sep = ';'
...
alias deactivate = source 'C:\Users\BrainzMedia\Desktop\mission_statement\Scripts\deactivate.nu'
